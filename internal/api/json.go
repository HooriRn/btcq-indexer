...
func toOapiDepthResponse(
	...
	for i, bucket := range depths {
		...
		openPriceUSD := floatStr(bucket.Depths.OpenPrice)
		highPriceUSD := floatStr(bucket.Depths.HighPrice)
		lowPriceUSD := floatStr(bucket.Depths.LowPrice)
		closePriceUSD := floatStr(bucket.Depths.ClosePrice)
